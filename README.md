...
<p align="left">I tend to use <strong>Next.js (React)</strong> and <strong>TypeScript</strong> on the front-end, and <strong>Node.js</strong> or <strong>Ruby</strong> for the back.</p>
